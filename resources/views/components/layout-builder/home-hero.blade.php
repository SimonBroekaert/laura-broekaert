	...
	<div class="container">
		<div class="items-center justify-between row">
			<article class="col-12 md:col-6 xl:col-5 mb-gap md:mb-0">
				<x-heading :level="2" :style-level="1" class="text-gray-dark">
					{{ $block->title }}
				</x-heading>
				...
				<div class="row">
					<div class="order-1 col-6 sm:col-4 md:col-6 xl:col-4">
						<div class="mb-20 overflow-hidden transition-all rounded shadow select-none betterhover:hover:shadow-lg bg-gray">
							<x-image :image="$block->images->first()" format="home-hero-portrait" class="aspect-3/4 md:aspect-9/16" data-aos-delay="1000"
								data-aos="fade" />
						</div>
						<div class="overflow-hidden transition-all rounded shadow select-none betterhover:hover:shadow-lg bg-gray">
							<x-image :image="$block->images->skip(1)->first()" format="home-hero-landscape" class="aspect-4/3 md:aspect-16/9" data-aos-delay="1000"
								data-aos="fade" />
						</div>
					</div>
					<div
