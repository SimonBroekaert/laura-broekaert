...
@php
	...
	$attributes = $attributes->merge([
	    'class' => "{$themeClasses} relative inline-block transition-all cursor-pointer select-none group/button after:-z-1 after:absolute after:top-10 after:left-10 after:border after:border-2 after:rounded after:w-full after:h-full no-underline",
	]);
